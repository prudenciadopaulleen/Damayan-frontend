      ...
      <section style={{ width: "min(84rem, 100%)", minHeight: "calc(100vh - 48px)", display: "grid", gridTemplateColumns: "minmax(352px, 0.9fr) minmax(0, 1fr)", borderRadius: 32, overflow: "hidden", background: "#fcfdfb", boxShadow: "0 30px 90px rgba(40,50,56,0.12)" }}>
          ...
          <div style={{ display: "grid", alignContent: "center", flex: 1 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 48 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12, letterSpacing: "0.14em", opacity: 0.86, textTransform: "uppercase" }}>Admin Portal</div>
              </div>
            </div>
            ...
            <h1 style={{ margin: "22px 0 18px", fontSize: 72, lineHeight: 0.98, letterSpacing: "-0.05em" }}>Oversee And Coordinate.</h1>
            <p style={{ margin: 0, maxWidth: 420, fontSize: 20, lineHeight: 1.8, color: "rgba(245,247,245,0.88)" }}>
              Access monitoring, approvals, reports, and system-wide visibility from the admin portal.
            </p>
          </div>
        ...
        <section style={{ padding: "56px", display: "flex", flexDirection: "column", justifyContent: "center", background: "#fcfdfb" }}>
          <div style={{ marginBottom: 24 }}>
            <span style={{ display: "inline-block", padding: "8px 14px", borderRadius: 999, background: "#d9f2d5", color: "#2e7d32", fontSize: 12, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 800 }}>Admin</span>
            <h2 style={{ margin: "18px 0 14px", fontSize: 58, lineHeight: 1.02, letterSpacing: "-0.05em", color: "#283238" }}>Admin Access</h2>
            <p style={{ margin: 0, color: "#5f6b66", fontSize: 18, lineHeight: 1.7 }}>Sign in to continue to the admin dashboard.</p>
          </div>
          ...
          <article style={{ maxWidth: 704, padding: 28, borderRadius: 24, background: "#ffffff", border: "1px solid rgba(46,125,50,0.14)", boxShadow: "0 18px 40px rgba(40,50,56,0.06)" }}>
            <div style={{ marginBottom: 20 }}>
              <h3 style={{ margin: "0 0 8px", fontSize: 24, letterSpacing: "-0.03em", color: "#283238" }}>Admin Login</h3>
              <p style={{ margin: 0, color: "#5f6b66", fontSize: 16 }}>Enter your account details below.</p>
            </div>

            <form onSubmit={handleSubmit} style={{ display: "grid", gap: 16 }}>
              <div style={{ display: "grid", gap: 8 }}>
                <label htmlFor="admin-username" style={{ color: "#5f6b66", fontSize: 12, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase" }}>Username</label>
                <input id="admin-username" type="text" placeholder="Enter username" style={{ width: "100%", padding: "16px 18px", borderRadius: 16, border: "1px solid rgba(129,199,132,0.38)", background: "#f5f7f5", outline: "none", fontSize: 16, boxSizing: "border-box", color: "#283238" }} />
              </div>

              <div style={{ display: "grid", gap: 8 }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
                  <label htmlFor="admin-password" style={{ color: "#5f6b66", fontSize: 12, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase" }}>Password</label>
                ...
                <input id="admin-password" type="password" placeholder="********" style={{ width: "100%", padding: "16px 18px", borderRadius: 16, border: "1px solid rgba(129,199,132,0.38)", background: "#f5f7f5", outline: "none", fontSize: 16, boxSizing: "border-box", color: "#283238" }} />
              </div>
